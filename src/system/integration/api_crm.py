...
class ApiBackend():
    ...
    def authf(self,username,password):
        try:
    ...
    def get_pessoa(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_pessoa(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/pessoa"
            headers={
    ...
    def patch_pessoa(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_pessoa_tipo(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_pessoa_tipo(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/pessoa_tipo"
            headers={
    ...
    def patch_pessoa_tipo(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_endereco(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_endereco(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/endereco"
            headers={
    ...
    def patch_endereco(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_contato(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_contato(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/contato"
            headers={
    ...
    def patch_contato(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_contato_tipo(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_contato_tipo(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/contato_tipo"
            headers={
    ...
    def patch_contato_tipo(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_caixa(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_caixa(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/caixa"
            headers={
    ...
    def patch_caixa(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def post_processar_conta(self,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_caixa_historico(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def get_conta(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_conta(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/conta"
            headers={
    ...
    def patch_conta(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_conta_tipo(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_conta_tipo(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/conta_tipo"
            headers={
    ...
    def patch_conta_tipo(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_documento_tipo(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_documento_tipo(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/documento_tipo"
            headers={
    ...
    def patch_documento_tipo(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_pagamento_tipo(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_pagamento_tipo(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/pagamento_tipo"
            headers={
    ...
    def patch_pagamento_tipo(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_categoria(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_categoria(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/categoria"
            headers={
    ...
    def patch_categoria(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_status(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_status(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/status"
            headers={
    ...
    def patch_status(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_empresa(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_empresa(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/empresa"
            headers={
    ...
    def patch_empresa(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_usuario(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_usuario(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/usuario"
            headers={
    ...
    def patch_usuario(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_rota(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_rota(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/rota"
            headers={
    ...
    def patch_rota(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_grupo_acesso(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_grupo_acesso(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/grupo_acesso"
            headers={
    ...
    def patch_grupo_acesso(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_grupo_acesso_rota(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_grupo_acesso_rota(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/grupo_acesso_rota"
            headers={
    ...
    def patch_grupo_acesso_rota(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_grupo_acesso_usuario(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_grupo_acesso_usuario(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/grupo_acesso_usuario"
            headers={
    ...
    def patch_grupo_acesso_usuario(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_integracao(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_integracao(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/integracao"
            headers={
    ...
    def patch_integracao(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_integracao_grupo(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_integracao_grupo(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/integracao_grupo"
            headers={
    ...
    def patch_integracao_grupo(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_integracao_saldo_empresa(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_integracao_saldo_empresa(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/integracao_saldo_empresa"
            headers={
    ...
    def patch_integracao_saldo_empresa(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_integracao_historico_saldo_empresa(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def post_integracao_historico_saldo_empresa(self,data:dict,token = None):
        try:
            # self.auth()
            url = f"{self.BASE_URL}/integracao_historico_saldo_empresa"
            headers={
    ...
    def patch_integracao_historico_saldo_empresa(self,id:int,data:dict,token = None):
        try:
            # self.auth()
    ...
    def get_hub_data(self,filters:dict,token = None):
        try:
            # self.auth()
    ...
    def get_google_calendar(self,filters:dict,token = None):
        """
            filter:{
                    calendar_id:str,
                    size:int
...
# teste = ApiBackend()
# response=teste.get_pessoa(filters={},token = request.state.token)
# print(response)
# response=teste.get_endereco(filters={},token = request.state.token)
# print(response)
# response=teste.get_contato(filters={},token = request.state.token)
# print(response)
# response=teste.get_caixa(filters={},token = request.state.token)
# print(response)
# response=teste.get_conta(filters={},token = request.state.token)
# print(response)
# response=teste.get_documento_tipo(filters={},token = request.state.token)
# print(response)
# response=teste.get_pagamento_tipo(filters={},token = request.state.token)
# print(response)
# response=teste.get_categoria(filters={},token = request.state.token)
# print(response)
# response=teste.get_status(filters={},token = request.state.token)
# print(response)
# response=teste.get_empresa(filters={},token = request.state.token)
# print(response)